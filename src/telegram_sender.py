...
async def send_briefing_header(
    bot, chat_id: int, weather_text: str = "", finance_text: str = "", verse: str = ""
) -> None:
...
async def send_text(
    bot, chat_id: int, text: str, parse_mode: str = "HTML", disable_preview: bool = True
) -> None:
