...
def _spot_cache_info(spot: dict) -> dict:
    ...
    if stype == 'llm':
        ...
        # Listar datas anteriores em cache
...
def gerar_spot(id_spot: str, forcar: bool = False) -> str:
    ...
    # Usar _get_audio do spots.py para gerar
...
def exportar_episodios(
    ...
    # Resolver caminhos reais (replays usam audio_path no episode.json)
